...
const CustomerList = () => {
    ...
    const allowedKeys = ["name", "email", "phone", "status","address"]
    const headerLabels = {
  name: "Customer",
  email: "Email",
  phone: "Phone",
  ...
  address: "Address",
    ...
    return (
        <div className="customTable w-full overflow-y-auto p-8 mb-4 flex items-center flex-col gap-5 justify-center">
                        ...
                        {paginatedData.map((item, index) => (
                            ...
                            >
                                <td className="p-3">
                                  ...
                                  <td className="p-3 dark:text-[#abc2d3]">{item.email}</td>
                                  <td className="p-3 dark:text-[#abc2d3]">{item.phone}</td>
                                  <td className="p-3 dark:text-[#abc2d3]">{item.status}</td>
                                  <td className="p-3 dark:text-[#abc2d3]">{item.address}</td>
